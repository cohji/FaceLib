...
namespace dlib
{
    namespace lapack
    {
        namespace binding
        {
            extern "C"
            {
                void DLIB_FORTRAN_ID_dgesdd(dgesdd) (char const* jobz,
                ...
                void DLIB_FORTRAN_ID_sgesdd(sgesdd) (char const* jobz,
            ...
            {
                integer info = 0;
                DLIB_FORTRAN_ID_dgesdd(dgesdd)(&jobz, &m, &n, a, &lda, s, u, &ldu, vt, &ldvt, work, &lwork, iwork, &info);
                return info;
            }
            ...
            {
                integer info = 0;
                DLIB_FORTRAN_ID_sgesdd(sgesdd)(&jobz, &m, &n, a, &lda, s, u, &ldu, vt, &ldvt, work, &lwork, iwork, &info);
                return info;
            }
        }
