...
namespace dlib
{
    namespace lapack
    {
        namespace binding
        {
            extern "C"
            {
                void DLIB_FORTRAN_ID_dsyev(dsyev) (char *jobz, char *uplo, integer *n, double *a,
                                             integer *lda, double *w, double *work, integer *lwork, 
                                             integer *info);

                void DLIB_FORTRAN_ID_ssyev(ssyev) (char *jobz, char *uplo, integer *n, float *a,
            ...
            {
                integer info = 0;
                DLIB_FORTRAN_ID_dsyev(dsyev)(&jobz, &uplo, &n, a,
            ...
            {
                integer info = 0;
                DLIB_FORTRAN_ID_ssyev(ssyev)(&jobz, &uplo, &n, a,
                                       &lda, w, work, &lwork, &info);
                return info;
            }
