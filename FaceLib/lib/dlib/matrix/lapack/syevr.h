...
namespace dlib
{
    namespace lapack
    {
        namespace binding
        {
            extern "C"
            {
                void DLIB_FORTRAN_ID_dsyevr(dsyevr) (char *jobz, char *range, char *uplo, integer *n,
                ...
                void DLIB_FORTRAN_ID_ssyevr(ssyevr) (char *jobz, char *range, char *uplo, integer *n,
            ...
            {
                integer info = 0;
                DLIB_FORTRAN_ID_dsyevr(dsyevr)(&jobz, &range, &uplo, &n,
                                        a, &lda, &vl, &vu, &il,
                                        &iu, &abstol, m, w,
                                        z, &ldz, isuppz, work,
            ...
            {
                integer info = 0;
                DLIB_FORTRAN_ID_ssyevr(ssyevr)(&jobz, &range, &uplo, &n,
                                        a, &lda, &vl, &vu, &il,
                                        &iu, &abstol, m, w,
                                        z, &ldz, isuppz, work,
                                        &lwork, iwork, &liwork, &info);
